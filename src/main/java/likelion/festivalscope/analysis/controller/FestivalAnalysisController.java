...
public class FestivalAnalysisController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "분석 결과 조회 성공", content = @Content(schema = @Schema(implementation = FestivalAnalysisResponse.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "TARGET_VISITOR 상세 조회 성공", content = @Content(schema = @Schema(implementation = TargetVisitorResponse.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "TREND_FIT 상세 조회 성공", content = @Content(schema = @Schema(implementation = TrendFitResponse.class))),
            @ApiResponse(responseCode = "404", description = "분석 또는 분석 항목을 찾을 수 없음", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "DEMAND_FIT 상세 조회 성공", content = @Content(schema = @Schema(implementation = DemandFitResponse.class))),
            @ApiResponse(responseCode = "404", description = "분석 또는 분석 항목을 찾을 수 없음", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
    ...
    */
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "TOURISM_LINKAGE 상세 조회 성공", content = @Content(schema = @Schema(implementation = TourismLinkageResponse.class))),
            @ApiResponse(responseCode = "401", description = "인증되지 않은 요청", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
